...
/*   Updated: 2022/03/07 14:45:50 by khirsig          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	inventory_draw(t_data *data)
{
	...
	DrawTextEx(data->window.font, get_currency_string(data, data->player.gold), (Vector2){ data->player.inv.gui.posX + data->player.inv.gui.lenX / 9 * 2, data->player.inv.gui.posY + data->player.inv.gui.lenY / 10 * 9.70 }, incr / 5, 1, GRAY);
	DrawTextEx(data->window.font, get_currency_string(data, data->player.soulgem), (Vector2){ data->player.inv.gui.posX + data->player.inv.gui.lenX / 13 * 8, data->player.inv.gui.posY + data->player.inv.gui.lenY / 10 * 9.70 }, incr / 5, 1, GRAY);
}
